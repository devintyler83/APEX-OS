...
Last Updated (UTC): 2026-03-29T04:48:52.162890+00:00
...
- Session 71: Investigate Arvell Reese (#2 consensus, pid=16) ELITE->DAY1 drop (-8.8 pts).
  Determine whether measurables context (forty=4.46, ATH=86.6, SPEED=72.6) mechanistically
  justifies the drop or represents a measurables over-weighting artifact. If justified:
  proceed with --batch all --force --apply 1 (full re-score). If artifact: add Reese to
  ARCHETYPE_OVERRIDES with score floor directive before full batch.
  After investigation decision: run --batch all, recompute divergence, re-run tag triggers,
  triage pending recs, doctor.
...
APEX: Operational. 140 v2.3 active non-cal scored + 12 calibration artifacts.
  ...
  Tiers (v2.3 active non-cal, post Session 70 top-50 re-score):
    Full board: ELITE=3, DAY1=35, DAY2=66, DAY3=34, UDFA-P=2 (approx — top-50 only re-scored)
    Top-50 subset: ELITE=3, DAY1=26, DAY2=20, DAY3=1, UDFA-P=0
  Decision gate: HOLD. Arvell Reese ELITE->DAY1 drop under investigation.
  Divergence: APEX_HIGH=63, ALIGNED=28, STRUCTURAL=45, APEX_LOW=4.
  ...
  Top premium APEX_HIGH (post-repoint, coverage artifacts resolved):
    Gabe Jacas EDGE (+81), R Mason Thomas EDGE (+80), Jadon Canady CB (+77),
    Daylen Everette CB (+69), Treydan Stukes S (+68), Malik Muhammad CB (+63), TJ Parker EDGE (+61).
  D'Angelo Ponds artifact RESOLVED (sources_covered 2->12, no longer APEX_HIGH).
