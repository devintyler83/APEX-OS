...
Last Updated (UTC): 2026-03-10T05:46:05.260250+00:00
...
- Session 9: Re-score top-50 against updated consensus ranks (universe migration changed all consensus_ranks).
  APEX divergence_delta values are now stale — they were computed against the inflated pre-universe ranks.
  Run: python -m scripts.run_apex_scoring_2026 --force (top-50 only, not calibration artifacts)
  Then verify: apex_scores divergence_delta distribution makes sense with new ranks.
...
6. Session 9: Re-score top-50 APEX with --force against updated consensus ranks (Session 8 changed all ranks)
